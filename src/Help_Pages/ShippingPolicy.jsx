      ...
      >
        ...
        <div style={{ margin: "0% 10% 10% 10%",
          ...
          <div className="div-p-ul">
            ...
            <p>Thank you for choosing RAVANDURU STORES a unit of A V KITCHENS.</p>
            <p>
            ...
            <p>
             Check your local customs policies before placing an order. Lost or Delayed Packages For delayed or lost packages, contact us at  <span style={{fontFamily:'oswald, sans-serif', letterSpacing:'1px', fontSize:'20px'}}>
              www.ravandurustores.com / av.kitchens1532@gmail.com.</span>. We will coordinate with the carrier to resolve the issue. Address Errors please double-check your shipping address at checkout. Orders sent to an incorrect address may incur additional shipping fees.
            </p>
            <ul>
            ...
            <p> Thank you for shopping with RAVANDURU STORES a unit of A V KITCHENS.</p>
          </div>
        </div>
      </Container>
